...
\question{Take as given that a $C^\infty$ $2$-form $\omega$ on $S^2$ is of the form $d \theta$ for
  ...
  every $C^\infty$ $2$-form $\Omega$ on \RP{2} has the form $d \Lambda $ for some
...
\subquestion{Suppose $F: S^1 \to \R^3$ is a $C^\infty$ function such that $dF$ is nowhere
...
\subquestion{Show that if $F: S^1 \to \R^4$ is $C^\infty$ and injective then there is a
...
\subquestion{Is a $C^\infty$ map $F: T^2 \to T^2$ of degree 1 necessarily homotopic to the identity
...
\subquestion{Can $X$ be made a $C^\infty$ manifold? Why or why not?}
