...
\question{Let \GLs{+}{n}{\R} be the set of $n \times n$ matrices with determinant $> 0$. Note that \GLs{+}{n}{\R} can be considered to be a subset of $\R^{n^2}$ and this subset is open.}
